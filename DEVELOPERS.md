...
Tagging  (update the version number):
    ...
    git tag -a 2.0.0a2 -m "New release."
    git push origin 2.0.0a2
...
Upload to pypi (update the version number) using
    ...
    twine upload dist/pandoc-theoremnos-2.0.0a2.tar.gz \
                 dist/pandoc_theoremnos-2.0.0a2-py3-none-any.whl
